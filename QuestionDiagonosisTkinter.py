...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login",bg="skyblue", height="2", width="300", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register",bg="lightgreen", height="2", width="300", command = self.btnRegister_Click)
